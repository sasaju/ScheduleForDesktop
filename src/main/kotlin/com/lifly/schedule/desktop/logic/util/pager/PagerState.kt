...
package com.lifly.schedule.desktop.logic.util.pager
...
class PagerState(
    ...
    var currentPage: Int
        ...
        internal set(value) {
            if (value != _currentPage) {
                _currentPage = value
                if (DebugLog) {
                    Repository.logger.info("Current page changed: $_currentPage")
                }
            }
        }
    ...
    @Deprecated(
        ...
        ReplaceWith("animateScrollToPage(page = page>0, pageOffset = 0<pageOffset<1.0)")
    )
